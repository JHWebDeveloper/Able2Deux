...
const CaptureModeSwitch = ({ screenshot, fill = '#444' }) => (
	<svg width="41px" height="26px" viewBox="0 0 41 26">
		...
		<path fill={fill} d="M28.263,2.377h1.334v1.334h-1.334v5.333h1.334v1.333h-1.334v1.334h12v-1.334h-1.334V9.044h1.334V3.711
		...
		<path fill={fill} d="M12.096,7.044v12c0,3.312,2.688,6,6,6s6-2.688,6-6v-12c0-3.312-2.688-6-6-6S12.096,3.732,12.096,7.044z"/>
		<circle fill="#eee" cx="18.096" cy={screenshot ? 19.045 : 7.043} r="3.601"/>
		<path fill="#7c7c7c" d="M8.806,13.544h-3.75c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5h3.75c0.276,0,0.5,0.224,0.5,0.5
