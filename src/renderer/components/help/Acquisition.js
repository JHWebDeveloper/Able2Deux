...
const Acquisition = () => (
	<section id="aquisition">
		...
		<p>On the right side of each media item is a remove button labeled with an <i>close</i>. Click this button at any time to remove the media or cancel a current download. If you are downloading from a live stream, this button will temporarily be replaced with a stop button <i>stop</i>. Clicking the stop button will stop the live download. You can also remove media in the formatting phase.</p>
		<p>You may rearrange the media items by dragging and dropping. You can also do this in the formatting phase with an accessible alternative in the media options menu.</p>
